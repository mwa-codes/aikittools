...
const seoSections = [
  {
    ...
    body: "The Color Picker and HEX Converter is a straightforward tool for anyone working with digital color. Pick a color from the visual palette and instantly see its value in HEX, RGB, and HSL — the three formats you'll encounter most when writing CSS, designing in Figma, or building a brand color system. HEX is the standard shorthand used in most stylesheets, RGB gives you precise channel control, and HSL makes it intuitive to create lighter or darker variants of the same hue. Instead of mentally converting between formats or hunting through documentation, this tool gives you all three values in one place with copy buttons for each.",
  },
  {
  ...
  },
  {
    ...
    body: "Free to use with no account or signup needed. Converts between all three major CSS color formats instantly without any page reloads. Everything runs in your browser, so it's lightweight and fast even on mobile — useful during design reviews, client calls, or quick CSS edits when you don't have your usual design tools open. No extensions, no installations, just open the page and start picking colors.",
  },
];
